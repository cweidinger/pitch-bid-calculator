...
This is a sample template for bid-calculator - Below is a brief explanation of what we have generated for you:
...
sam package \
    ...
    --s3-bucket clayweidinger-lambda-code
```
says 
```
aws cloudformation deploy --template-file /Users/clayweidinger/git/bid-calculator/packaged.yaml --stack-name <YOUR STACK NAME>
```
But
...
sam deploy \
    ...
    --stack-name pitch-bid-calculator \
...
aws cloudformation describe-stacks \
    --stack-name pitch-bid-calculator --query 'Stacks[].Outputs'
```
